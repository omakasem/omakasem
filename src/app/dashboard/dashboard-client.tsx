      ...
      {stories.length > 0 && (
        <div className="flex flex-col gap-[12px]">
          <div className="flex items-center justify-between gap-[2px] p-[4px]">
            <span className="text-[18px] leading-[1.45] font-medium tracking-[-0.02em] text-[#161616] dark:text-[#F5F5F5]">
              Story 구성
            </span>
            <span className="text-right text-[16px] leading-[1.5] font-normal tracking-[-0.02em] text-[rgba(22,22,22,0.72)] dark:text-[rgba(245,245,245,0.72)]">
              {oneLiner}
            </span>
          </div>
